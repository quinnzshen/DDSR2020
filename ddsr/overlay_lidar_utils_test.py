...
def test_generate_lidar_point_coord_camera_image():
    ...
    lidar_point_coord_camera_image, filtered_index = olu.generate_lidar_point_coord_camera_image(
        lidar_point_coord_velodyne, camera_image_from_velodyne, 100, 100)
